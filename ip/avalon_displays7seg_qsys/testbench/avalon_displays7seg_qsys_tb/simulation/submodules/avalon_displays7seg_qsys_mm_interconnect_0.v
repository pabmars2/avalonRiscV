// avalon_displays7seg_qsys_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module avalon_displays7seg_qsys_mm_interconnect_0 (
	...
	wire         mm_master_bfm_0_m0_translator_avalon_universal_master_0_waitrequest;   // avalon_displays7seg_0_avalon_slave_translator:uav_waitrequest -> mm_master_bfm_0_m0_translator:uav_waitrequest
	wire  [31:0] mm_master_bfm_0_m0_translator_avalon_universal_master_0_readdata;      // avalon_displays7seg_0_avalon_slave_translator:uav_readdata -> mm_master_bfm_0_m0_translator:uav_readdata
	wire         mm_master_bfm_0_m0_translator_avalon_universal_master_0_debugaccess;   // mm_master_bfm_0_m0_translator:uav_debugaccess -> avalon_displays7seg_0_avalon_slave_translator:uav_debugaccess
	wire   [4:0] mm_master_bfm_0_m0_translator_avalon_universal_master_0_address;       // mm_master_bfm_0_m0_translator:uav_address -> avalon_displays7seg_0_avalon_slave_translator:uav_address
	wire         mm_master_bfm_0_m0_translator_avalon_universal_master_0_read;          // mm_master_bfm_0_m0_translator:uav_read -> avalon_displays7seg_0_avalon_slave_translator:uav_read
	wire   [3:0] mm_master_bfm_0_m0_translator_avalon_universal_master_0_byteenable;    // mm_master_bfm_0_m0_translator:uav_byteenable -> avalon_displays7seg_0_avalon_slave_translator:uav_byteenable
	wire         mm_master_bfm_0_m0_translator_avalon_universal_master_0_readdatavalid; // avalon_displays7seg_0_avalon_slave_translator:uav_readdatavalid -> mm_master_bfm_0_m0_translator:uav_readdatavalid
	wire         mm_master_bfm_0_m0_translator_avalon_universal_master_0_lock;          // mm_master_bfm_0_m0_translator:uav_lock -> avalon_displays7seg_0_avalon_slave_translator:uav_lock
	wire         mm_master_bfm_0_m0_translator_avalon_universal_master_0_write;         // mm_master_bfm_0_m0_translator:uav_write -> avalon_displays7seg_0_avalon_slave_translator:uav_write
	wire  [31:0] mm_master_bfm_0_m0_translator_avalon_universal_master_0_writedata;     // mm_master_bfm_0_m0_translator:uav_writedata -> avalon_displays7seg_0_avalon_slave_translator:uav_writedata
	wire   [2:0] mm_master_bfm_0_m0_translator_avalon_universal_master_0_burstcount;    // mm_master_bfm_0_m0_translator:uav_burstcount -> avalon_displays7seg_0_avalon_slave_translator:uav_burstcount
