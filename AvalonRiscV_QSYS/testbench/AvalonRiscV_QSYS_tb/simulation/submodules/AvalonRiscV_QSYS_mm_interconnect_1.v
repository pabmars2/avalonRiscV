...
module AvalonRiscV_QSYS_mm_interconnect_1 (
	...
	wire         risc_v_avalon_0_master_external_translator_avalon_universal_master_0_waitrequest;   // externalMemory_s1_translator:uav_waitrequest -> RISC_V_AVALON_0_master_external_translator:uav_waitrequest
	wire  [31:0] risc_v_avalon_0_master_external_translator_avalon_universal_master_0_readdata;      // externalMemory_s1_translator:uav_readdata -> RISC_V_AVALON_0_master_external_translator:uav_readdata
	wire         risc_v_avalon_0_master_external_translator_avalon_universal_master_0_debugaccess;   // RISC_V_AVALON_0_master_external_translator:uav_debugaccess -> externalMemory_s1_translator:uav_debugaccess
	wire  [31:0] risc_v_avalon_0_master_external_translator_avalon_universal_master_0_address;       // RISC_V_AVALON_0_master_external_translator:uav_address -> externalMemory_s1_translator:uav_address
	wire         risc_v_avalon_0_master_external_translator_avalon_universal_master_0_read;          // RISC_V_AVALON_0_master_external_translator:uav_read -> externalMemory_s1_translator:uav_read
	wire   [3:0] risc_v_avalon_0_master_external_translator_avalon_universal_master_0_byteenable;    // RISC_V_AVALON_0_master_external_translator:uav_byteenable -> externalMemory_s1_translator:uav_byteenable
	wire         risc_v_avalon_0_master_external_translator_avalon_universal_master_0_readdatavalid; // externalMemory_s1_translator:uav_readdatavalid -> RISC_V_AVALON_0_master_external_translator:uav_readdatavalid
	wire         risc_v_avalon_0_master_external_translator_avalon_universal_master_0_lock;          // RISC_V_AVALON_0_master_external_translator:uav_lock -> externalMemory_s1_translator:uav_lock
	wire         risc_v_avalon_0_master_external_translator_avalon_universal_master_0_write;         // RISC_V_AVALON_0_master_external_translator:uav_write -> externalMemory_s1_translator:uav_write
	wire  [31:0] risc_v_avalon_0_master_external_translator_avalon_universal_master_0_writedata;     // RISC_V_AVALON_0_master_external_translator:uav_writedata -> externalMemory_s1_translator:uav_writedata
	wire   [2:0] risc_v_avalon_0_master_external_translator_avalon_universal_master_0_burstcount;    // RISC_V_AVALON_0_master_external_translator:uav_burstcount -> externalMemory_s1_translator:uav_burstcount
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                                                      //                      clk.clk
		.reset                  (RISC_V_AVALON_0_reset_sink_reset_bridge_in_reset_reset),                             //                    reset.reset
		.uav_address            (risc_v_avalon_0_master_external_translator_avalon_universal_master_0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (risc_v_avalon_0_master_external_translator_avalon_universal_master_0_burstcount),    //                         .burstcount
		.uav_read               (risc_v_avalon_0_master_external_translator_avalon_universal_master_0_read),          //                         .read
		.uav_write              (risc_v_avalon_0_master_external_translator_avalon_universal_master_0_write),         //                         .write
		.uav_waitrequest        (risc_v_avalon_0_master_external_translator_avalon_universal_master_0_waitrequest),   //                         .waitrequest
